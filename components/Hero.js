      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:text-left">
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <a rel="noopener noreferrer" href="mailto:jukka.pajarinen@lumitum.com" className="px-8 py-3 text-lg font-semibold rounded bg-teal-600 hover:lg:bg-teal-500 text-gray-50">Lähetä sähköpostia</a>
            <a rel="noopener noreferrer" href="https://lumitum.com" target="_blank" className="px-8 py-3 text-lg font-semibold border rounded border-gray-800 hover:text-teal-600 hover:border-teal-600">Lumitum Oy</a>
          </div>
        </div>
